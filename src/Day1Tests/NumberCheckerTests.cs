...
namespace Day1Tests.NumberCheckerTests
{
    ...
    public class When_checking_number_with_acceptable_value_two_values
    {
        ...
        public void Then_the_correct_number_is_returned()
        {
            ...
            Assume.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, out var testValue), Is.True);
        ...
        {
            Assume.That(firstNumber+secondNumber, Is.EqualTo(2020));
            Assert.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, out _), Is.True);
        }
    }
    ...
    public class When_checking_number_with_unacceptable_value_two_values
    {
        ...
        {
            Assume.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, out var testValue), Is.False);
        ...
        {
            Assert.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, out _), Is.False);
        }
    }
    ...
    public class When_checking_number_with_acceptable_value_three_values
    {
        ...
        {
            Assume.That(firstNumber+secondNumber, Is.EqualTo(2020));
            Assume.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, thirdNumber, out var testValue), Is.True);
        ...
        {
            Assume.That(firstNumber+secondNumber, Is.EqualTo(2020));
            Assert.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, thirdNumber, out _), Is.True);
        }
    }
    ...
    public class When_checking_number_with_unacceptable_value_three_values
    {
        ...
        public void Then_the_correct_number_is_not_returned()
        {
            Assume.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, thirdNumber, out var testValue), Is.False);
            Assert.That(testValue, Is.Null);
        }
        ...
        public void Then_the_result_is_false()
        {
            Assert.That(NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstNumber, secondNumber, thirdNumber, out _), Is.False);
        }
    }
}