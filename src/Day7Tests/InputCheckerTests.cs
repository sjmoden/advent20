...
namespace Day7Tests.InputCheckerTests
{
    [TestFixture]
    public class When_running_input_checker_with_example_values_part1
    {
        ...
        {
            Assert.That(_sut.CheckInputToGetAnswerPart1(), Is.EqualTo("4"));
        }
    }
    [TestFixture]
    public class When_running_input_checker_with_example_values_part2
    {
        ...
        {
            Assert.That(_sut.CheckInputToGetAnswerPart2(), Is.EqualTo("126"));
        }
    }
}