        ...
        public int CheckInputToGetAnswerPart1()
        {
            ...
            for(var  i =0; i<values.Length-1;i++)
            {
                ...
                for (var j = i + 1; j < values.Length-1; j++)
                {
                    ...
                    if (NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstValue, secondValue, out var combinedValue) && combinedValue != null)
                    {
            ...
            for(var  i =0; i<values.Length-1;i++)
            {
                ...
                for (var j = i + 1; j < values.Length-1; j++)
                {
                    ...
                    for (var k = j + 1; k < values.Length - 1; k++)
                    {
                        ...
                        if (NumberChecker.TryGetCombinedNumberWhenAddingTo2020(firstValue, secondValue,thirdValue, out var combinedValue) && combinedValue != null)
                        {
                            return (int)combinedValue;
                        }
                    }
